...
**Tanks: a slot for the buff you keep rolling** - Shield Block, Shield of the Righteous, Ironfur, Demon Spikes, Bone Shield - the one mitigation buff your spec maintains gets its own slot beside the defensive queue, counting down its real remaining time and glowing blue as it runs low. Refresh before you lose it, not after. (Brewmaster isn't covered yet.)
