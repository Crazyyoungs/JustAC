...
- **Crowd Control Escape** *(Experimental, opt-in)* - while you're held by crowd control the game reports to addons (stuns, roots, fears) and carry something ready to break it, the maintenance slot's frame turns into that escape button, counting down the effect until you're free. Any spec. Movement slows can't be detected in combat, so they aren't covered. Off by default under Defensives → Crowd Control Escape
