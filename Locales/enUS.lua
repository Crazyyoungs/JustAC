...
L["Spacing"] = "Spacing"
L["Primary Spell Scale"] = "Position 1 Scale"
...
L["Primary Only"] = "Position 1 Only"
...
L["Max Icons desc"] = "Maximum spell icons to display (1 = Blizzard's pick, 2+ = upcoming queue)"
L["Icon Size desc"] = "Base size of spell icons in pixels"
L["Spacing desc"] = "Gap between icons in pixels"
L["Primary Spell Scale desc"] = "Scale multiplier for the position 1 icon (Blizzard's pick)"
...
L["Include All Available Abilities desc"] = "Include spells hidden behind macro conditionals like [mod:shift] in Blizzard's pick (position 1)."
...
L["Click to Cast"] = "Click to Cast (Out of Combat)"
L["Click to Cast desc"] = "Left-click queue icons out of combat to cast or use them - handy for pre-pull buffs and setup. Hidden in combat and in Click Through mode. Casts the specific ability directly (no assisted-combat penalty); use your keybinds in combat."
...
L["Blacklist Info"] = "Hides a spell or item from every position: main queue, nameplate overlay, and burst/gap-closer injection.\n\n|cffff6666Shift+Right-click|r any queue icon to blacklist it directly. (The Rotation tab only edits positions 2+.)"
L["Blacklist Warning"] = "|cFFFF4444Caution:|r Blacklisting position 1 (Blizzard's pick) can stall the rotation. Turn off |cffFFAA00Apply to Position 1|r on an entry to hide it from positions 2+ only and keep the rotation flowing."
L["Blacklist Position 1"] = "Apply to Position 1"
L["Blacklist Position 1 desc"] = "Also hide this ability at position 1 (Blizzard's pick). |cffFFAA00Turn off|r to hide it only from positions 2+. Position 1 keeps showing it, so Blizzard's rotation doesn't stall."
...
L["Custom Queue Position Note"] = "|cffffd100Position 1 is always Blizzard's live pick|r and JustAC can't change it. Everything on this tab controls positions 2+: the queue of abilities shown as coming up next."
L["Custom Queue Info"] = "Build your own upcoming queue instead of mirroring Blizzard's. Enable it below, then reorder, trim, or add abilities. It starts seeded from Blizzard's Assisted Combat rotation for your spec.\n\nTo hide an ability everywhere, |cffff6666shift+right-click|r its queue icon."
L["Custom Queue Ordering"] = "Ordering"
L["Custom Queue Ordering Note"] = "How the upcoming queue is ordered, for both your Custom Rotation and Blizzard's. All on (default): smart order. Turn all off to keep the source order exactly."
...
L["Custom Queue Context Aware desc"] = "Reorder positions 2+ to fit the current situation, ahead of your saved order:\n\n- Single-target abilities rise against one enemy; AoE / cleave abilities rise against several.\n- Melee abilities sink while your target is out of melee range.\n\nOff: ignore the situation and keep your exact order."
L["Custom Queue Sink Cooldowns"] = "Cooldowns last"
L["Custom Queue Sink Cooldowns desc"] = "Move abilities that are on cooldown or out of charges to the end of the queue. Off: keep them in their listed position."
...
L["Enable Custom Queue"] = "Enable Custom Rotation"
L["Enable Custom Queue desc"] = "When enabled, your Custom Rotation sets positions 2+. Disable to use Blizzard's rotation."
L["Custom Queue Spells"] = "Custom Rotation"
L["Custom Queue Spells desc"] = "Your ability order for positions 2+. Use Up / Dn to reorder; the Ordering options above still apply."
...
L["Custom Queue Stale Chat"] = "Custom Rotation may be outdated:"
