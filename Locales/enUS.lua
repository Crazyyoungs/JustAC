...
L["Custom Queue Sink Cooldowns desc"] = "Move abilities that are on cooldown, out of charges, currently unusable (like Execute above its health threshold), or out of range (like Heroic Throw in melee) to the end of the queue. Off: keep them in their listed position."
