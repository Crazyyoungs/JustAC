...
L["Custom Queue Position Note"] = "|cffffd100The AC slot is always Blizzard's live pick|r and JustAC can't change it. Everything on this tab controls the queue: the abilities shown after it."
...
L["Custom Queue Sink Cooldowns desc"] = "Move abilities that are on cooldown, out of charges, or currently unusable (like Execute above its health threshold) to the end of the queue. Off: keep them in their listed position."
...
L["Enable Custom Queue desc"] = "When enabled, your Custom Rotation sets the queue. Disable to use Blizzard's rotation."
