...
L["Spacing"] = "Abstand"
L["Primary Spell Scale"] = "Skalierung Position 1"
...
L["Max Icons desc"] = "Maximale Zaubersymbole (1 = Blizzards Auswahl, 2+ = kommende Warteschlange)"
L["Icon Size desc"] = "Basisgröße der Symbole in Pixeln"
L["Spacing desc"] = "Abstand zwischen Symbolen in Pixeln"
L["Primary Spell Scale desc"] = "Skalierungsfaktor für das Symbol an Position 1 (Blizzards Auswahl)"
...
L["Include All Available Abilities desc"] = "Zauber einbeziehen, die hinter Makro-Bedingungen wie [mod:shift] versteckt sind, in Blizzards Auswahl (Position 1)."
...
L["Blacklist Info"] = "Blendet einen Zauber oder Gegenstand an jeder Position aus: Haupt-Warteschlange, Namensplaketten-Overlay und Stoß-/Annäherungs-Injektion.\n\n|cffff6666Umschalt+Rechtsklick|r auf ein beliebiges Warteschlangen-Symbol, um es direkt zu sperren. (Der Rotations-Tab bearbeitet nur Positionen 2+.)"
L["Blacklist Warning"] = "|cFFFF4444Vorsicht:|r Das Sperren von Position 1 (Blizzards Auswahl) kann die Rotation stoppen. Deaktiviere |cffFFAA00Auf Position 1 anwenden|r bei einem Eintrag, um ihn nur an Positionen 2+ auszublenden und die Rotation am Laufen zu halten."
...
L["Blacklist Position 1 desc"] = "Diese Fähigkeit auch an Position 1 (Blizzards Auswahl) ausblenden. |cffFFAA00Deaktivieren|r, um sie nur an Positionen 2+ auszublenden. Position 1 zeigt sie weiterhin, damit Blizzards Rotation nicht stoppt."
...
L["Custom Queue Position Note"] = "|cffffd100Position 1 ist immer Blizzards Live-Auswahl|r und JustAC kann sie nicht ändern. Alles in diesem Tab steuert die Positionen 2+: die Warteschlange der Fähigkeiten, die als nächstes anstehen."
...
L["Custom Queue Context Aware desc"] = "Positionen 2+ an die aktuelle Situation anpassen, vor deine gespeicherte Reihenfolge:\n\n- Einzelziel-Fähigkeiten steigen gegen einen Gegner; AoE-/Flächenfähigkeiten steigen gegen mehrere.\n- Nahkampffähigkeiten sinken, während dein Ziel außer Nahkampfreichweite ist.\n\nAus: die Situation ignorieren und deine exakte Reihenfolge beibehalten."
...
L["Enable Custom Queue desc"] = "Wenn aktiviert, legt deine Eigene Rotation die Positionen 2+ fest. Deaktivieren, um Blizzards Rotation zu verwenden."
L["Custom Queue Spells"] = "Eigene Rotation"
L["Custom Queue Spells desc"] = "Deine Fähigkeitsreihenfolge für Positionen 2+. Hoch / Runter zum Sortieren verwenden; die Reihenfolge-Optionen oben gelten weiterhin."
