...
L["Spacing"] = "Espaciado"
L["Primary Spell Scale"] = "Escala de posición 1"
...
L["Primary Only"] = "Solo posición 1"
...
L["Max Icons desc"] = "Iconos máximos a mostrar (1 = elección de Blizzard, 2+ = cola siguiente)"
L["Icon Size desc"] = "Tamaño base de los iconos en píxeles"
L["Spacing desc"] = "Espacio entre iconos en píxeles"
L["Primary Spell Scale desc"] = "Multiplicador de escala para el icono de posición 1 (elección de Blizzard)"
...
L["Include All Available Abilities desc"] = "Incluir hechizos ocultos tras condicionales de macro como [mod:shift] en la elección de Blizzard (posición 1)."
...
L["Blacklist Info"] = "Oculta un hechizo u objeto de todas las posiciones: cola principal, overlay de placa e inyección de ráfaga/acercamiento.\n\n|cffff6666Shift+Clic derecho|r en cualquier icono de la cola para añadirlo a la lista negra directamente. (La pestaña Rotación solo edita las posiciones 2+.)"
L["Blacklist Warning"] = "|cFFFF4444Precaución:|r Añadir la posición 1 (la elección de Blizzard) a la lista negra puede bloquear la rotación. Desactiva |cffFFAA00Aplicar a posición 1|r en una entrada para ocultarla solo de las posiciones 2+ y mantener la rotación fluida."
...
L["Blacklist Position 1 desc"] = "Ocultar también esta habilidad en la posición 1 (la elección de Blizzard). |cffFFAA00Desactívalo|r para ocultarla solo de las posiciones 2+. La posición 1 la sigue mostrando, así la rotación de Blizzard no se bloquea."
...
L["Custom Queue Position Note"] = "|cffffd100La posición 1 siempre es la elección en vivo de Blizzard|r y JustAC no puede cambiarla. Todo en esta pestaña controla las posiciones 2+: la cola de habilidades que se muestran como siguientes."
...
L["Custom Queue Context Aware desc"] = "Reordenar las posiciones 2+ para ajustarse a la situación actual, por delante de tu orden guardado:\n\n- Las habilidades de objetivo único suben contra un enemigo; las de AoE / daño en área suben contra varios.\n- Las habilidades cuerpo a cuerpo bajan mientras el objetivo está fuera de alcance.\n\nDesactivado: ignora la situación y mantiene tu orden exacto."
...
L["Enable Custom Queue desc"] = "Cuando esté activado, tu Rotación personalizada establece las posiciones 2+. Desactiva para usar la rotación de Blizzard."
L["Custom Queue Spells"] = "Rotación personalizada"
L["Custom Queue Spells desc"] = "Tu orden de habilidades para las posiciones 2+. Usa Arriba / Abajo para reordenar; las opciones de Ordenación de arriba siguen aplicándose."
