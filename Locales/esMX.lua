...
L["Max Icons desc"] = "Iconos máximos a mostrar (1 = elección de Blizzard, 2+ = cola próxima)"
L["Icon Size desc"] = "Tamaño base de los iconos en píxeles"
L["Spacing desc"] = "Espacio entre iconos en píxeles"
L["Primary Spell Scale desc"] = "Multiplicador de escala para el icono de la posición 1 (la elección de Blizzard)"
...
L["Blacklist Warning"] = "|cFFFF4444Cuidado:|r poner en lista negra la posición 1 (la elección de Blizzard) puede bloquear la rotación. Desactiva |cffFFAA00Aplicar a posición 1|r en una entrada para ocultarla solo de las posiciones 2+ y mantener la rotación fluida."
...
L["Blacklist Position 1 desc"] = "Ocultar también esta habilidad en la posición 1 (la elección de Blizzard). |cffFFAA00Desactiva|r para ocultarla solo de las posiciones 2+. La posición 1 la sigue mostrando, así la rotación de Blizzard no se bloquea."
...
L["Custom Queue Position Note"] = "|cffffd100La posición 1 siempre es la elección en vivo de Blizzard|r y JustAC no puede cambiarla. Todo en esta pestaña controla las posiciones 2+: la cola de habilidades que se muestra como próximas."
L["Custom Queue Info"] = "Crea tu propia cola próxima en lugar de reflejar la de Blizzard. Actívala abajo y luego reordena, recorta o añade habilidades. Empieza tomada de la rotación de Combate asistido de Blizzard para tu especialización.\n\nPara ocultar una habilidad en todas partes, |cffff6666Shift+Clic derecho|r en su icono de la cola."
...
L["Custom Queue Context Aware desc"] = "Reordenar las posiciones 2+ para ajustarse a la situación actual, por delante de tu orden guardado:\n\n- Las habilidades de objetivo único suben contra un enemigo; las de AoE / daño en área suben contra varios.\n- Las habilidades cuerpo a cuerpo bajan mientras el objetivo está fuera de alcance cuerpo a cuerpo.\n\nDesactivado: ignorar la situación y mantener tu orden exacto."
L["Custom Queue Sink Cooldowns"] = "Enfriamientos al final"
L["Custom Queue Sink Cooldowns desc"] = "Mover al final de la cola las habilidades que están en recarga. Desactivado: mantenerlas en su posición de la lista."
...
L["Enable Custom Queue desc"] = "Cuando esté activada, tu Rotación personalizada define las posiciones 2+. Desactiva para usar la rotación de Blizzard."
L["Custom Queue Spells"] = "Rotación personalizada"
L["Custom Queue Spells desc"] = "Tu orden de habilidades para las posiciones 2+. Usa Arriba / Abajo para reordenar; las opciones de Orden de arriba siguen aplicándose."
