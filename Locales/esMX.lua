...
L["Hide Emergency Until Low desc"] = "Por encima del umbral de salud baja, deja los botones de pánico - burbujas de inmunidad, grandes sanaciones instantáneas y pociones de salud - al final de la cola, oscurecidos con una etiqueta ESPE en lugar de mostrarse como sugerencias activas. Se iluminan y suben al frente cuando la salud baja del umbral. La mitigación y los rellenos se muestran normalmente. (Las sanaciones gratuitas activadas nunca se retienen.)"
