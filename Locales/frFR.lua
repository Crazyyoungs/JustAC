...
L["Primary Spell Scale"] = "Échelle de la position 1"
...
L["Primary Only"] = "Position 1 uniquement"
...
L["Max Icons desc"] = "Nombre maximum d'icônes de sort (1 = choix de Blizzard, 2+ = file à venir)"
L["Icon Size desc"] = "Taille de base des icônes en pixels"
L["Spacing desc"] = "Espace entre les icônes en pixels"
L["Primary Spell Scale desc"] = "Multiplicateur d'échelle pour l'icône en position 1 (choix de Blizzard)"
...
L["Include All Available Abilities desc"] = "Inclure les sorts cachés derrière des conditions de macro comme [mod:shift] dans le choix de Blizzard (position 1)."
...
L["Blacklist Info"] = "Masque un sort ou objet de toutes les positions : file principale, overlay de plaque, et injection d'élan/d'approche.\n\n|cffff6666Maj+Clic droit|r sur une icône de file pour la mettre directement en liste noire. (L'onglet Rotation ne modifie que les positions 2+.)"
L["Blacklist Warning"] = "|cFFFF4444Attention :|r Mettre la position 1 (choix de Blizzard) en liste noire peut bloquer la rotation. Désactivez |cffFFAA00Appliquer à la position 1|r sur une entrée pour la masquer des positions 2+ uniquement et garder la rotation fluide."
...
L["Blacklist Position 1 desc"] = "Masquer aussi cette capacité en position 1 (choix de Blizzard). |cffFFAA00Désactivez|r pour la masquer des positions 2+ uniquement. La position 1 continue de l'afficher, pour que la rotation de Blizzard ne bloque pas."
...
L["Custom Queue Position Note"] = "|cffffd100La position 1 est toujours le choix en direct de Blizzard|r et JustAC ne peut pas la changer. Tout dans cet onglet contrôle les positions 2+ : la file des capacités annoncées comme suivantes."
L["Custom Queue Info"] = "Construisez votre propre file à venir au lieu de refléter celle de Blizzard. Activez-la ci-dessous, puis réorganisez, élaguez ou ajoutez des capacités. Elle démarre initialisée depuis la rotation Combat assisté de Blizzard pour votre spécialisation.\n\nPour masquer une capacité partout, |cffff6666Maj+Clic droit|r sur son icône de file."
...
L["Custom Queue Context Aware desc"] = "Réorganiser les positions 2+ pour s'adapter à la situation actuelle, avant votre ordre enregistré :\n\n- Les capacités cible unique remontent contre un seul ennemi ; les capacités AoE / d'estoc remontent contre plusieurs.\n- Les capacités de mêlée descendent quand la cible est hors de portée de mêlée.\n\nDésactivé : ignorer la situation et garder votre ordre exact."
L["Custom Queue Sink Cooldowns"] = "Recharges en dernier"
L["Custom Queue Sink Cooldowns desc"] = "Placer les capacités en recharge à la fin de la file. Désactivé : les garder à leur position listée."
...
L["Enable Custom Queue desc"] = "Quand activé, votre Rotation personnalisée définit les positions 2+. Désactiver pour utiliser la rotation de Blizzard."
L["Custom Queue Spells"] = "Rotation personnalisée"
L["Custom Queue Spells desc"] = "Votre ordre de capacités pour les positions 2+. Utilisez Haut / Bas pour réordonner ; les options d'Ordre ci-dessus s'appliquent toujours."
